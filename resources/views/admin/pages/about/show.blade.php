        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form role="form"
                        action="{{ route('abouts.update', ['id' => $item['id']]) }}"
                        ...
                        <div class="form-group">
                            <label for="inputLinkYoutube">Link youyube</label>
                            <textarea name="link_youtube" id="inputLinkYoutube" rows="5" class="form-control" placeholder="Link youyube">{{ $item['link_youtube'] }}</textarea>
                        </div>
                        <div class="form-group">
