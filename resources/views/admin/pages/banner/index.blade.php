        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Listar Banners</h3>
                        ...
                        <tbody>
                            @foreach($items as $item)
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" onclick="confirmDelete('{{ route('banners.delete', ['id' => $item['id']]) }}')" class="btn btn-sm btn-danger">Excluir</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
